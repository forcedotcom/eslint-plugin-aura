...
module.exports = {
  ...
  rules: {
    ...
    'new-parens': ERROR,
    radix: ERROR,
    // Locker implicitly enables strict mode - https://developer.salesforce.com/docs/atlas.en-us.lightning.meta/lightning/security_strict_mode.htm?search_text=strict
    // strict: [ERROR, 'global'],
    'use-isnan': ERROR,
    'valid-typeof': ERROR,
